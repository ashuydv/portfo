                ...
                <div className="container px-5 py-16 mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div className="grid grid-rows-1 gap-5">
                            <div className="bg-[#f46f6f] border-4 border-[#171717] rounded-[8px] p-8 font-medium drop-shadow-[5px_5px_0px_rgba(0,0,0,1)]">
                                ...
                                >
                                    <a className="text-black text-[18px] inline-flex mt-5 items-center underline underline-offset-4">Learn More</a>
                                </Link>
                            </div>

                            {/* Item 2 */}
                            <div className="bg-[#31d4ad] border-4 border-[#171717] rounded-[8px] p-8 font-medium drop-shadow-[5px_5px_0px_rgba(0,0,0,1)]">
                                <div className="flex items-center justify-between">
                                    <h2 className="text-[24px] text-gray-900 font-bold title-font mb-2">
                                        MetagenStudios LLP
                                    </h2>
                                ...
                                <Link
                                    href="#"
                                >
                                    <a className="text-black inline-flex mt-5 items-center underline underline-offset-4 text-[18px]">Learn More</a>
                                </Link>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 gap-5">
                            {/* Item 3 */}
                            <div className="bg-[#d1a4ff] border-4 border-[#171717] rounded-[8px] p-8 font-medium drop-shadow-[5px_5px_0px_rgba(0,0,0,1)]">
                                <div className="flex items-center justify-between">
                                    <h2 className="text-[24px] text-gray-900 font-bold title-font mb-2">
                            ...
                            {/* Item 4 */}
                            <div className="bg-[#53c6ff] border-4 border-[#171717] rounded-[8px] p-8 font-medium drop-shadow-[5px_5px_0px_rgba(0,0,0,1)]">
                                <div className="flex items-center justify-between">
                                    <h2 className="text-[24px] text-gray-900 font-bold title-font mb-2">
                    ...
                    <div className="grid grid-cols-3 my-5 gap-5">
                        {/* Item 5 */}
                        <div className="bg-[#91db51] border-4 border-[#171717] rounded-[8px] p-8 font-medium drop-shadow-[5px_5px_0px_rgba(0,0,0,1)]">
                            <div className="flex items-center justify-between">
                                <h2 className="text-[24px] text-gray-900 font-bold title-font mb-2">
                        ...
                        {/* Item 5 */}
                        <div className="bg-[#f1a651] border-4 border-[#171717] rounded-[8px] p-8 font-medium drop-shadow-[5px_5px_0px_rgba(0,0,0,1)]">
                            <div className="flex items-center justify-between">
                                <h2 className="text-[24px] text-gray-900 font-bold title-font mb-2">
